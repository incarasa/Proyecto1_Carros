...
public class PanelCrearCliente extends JPanel implements ActionListener
{
	...
	public PanelCrearCliente(ventanaCliente ventanaCliente)
	{
	...
	{
		ventanaCliente.crearCliente(txtUsuario.getText(), txtContraseña.getText(), "cliente", 
				txtNombreCliente.getText(), txtNumeroDocumento.getText(), txtTelefono.getText(),
